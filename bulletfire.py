...
try:
    ...
    time.sleep(1)
    os.system('Then type: python2 bulletfire')
...
\033[1;94mFACEBOOK  AARYAN KHAN
                  
\033[1;92mFB PAGE   AARYAN KHAN
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓 AARYAN KHAN            ║║
║  GITHUB 💝💝💝 AARYANKHAN(AK)   ║ ║
║ FACEBOOK 💝💝💝Aaryan-HACKER ║ ║
║  ENJOY 💝💝💝Pak Cloning                ║ ║
...
╚══════╝ ╚═════╝ ╚══════╝╚═════╝ ╚═╝╚══════╝╚═╝  ╚═╝
                              ...
                              PUPIL OF IMRAN KHAN
                                  AARYAN-KHAN          
                                    TNX(AK)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓 AARYAN KHAN (AK)                              ║
║  GITHUB 💝💝💝 PSYCHOSOLDIER                           ║
║ FACEBOOK 💝💝💝AARYAN-HACKER                 ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝Use Fastest Speed Net             ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: AARYAN-KHAN(A.K)
Facebook: AARYAN-HACKER

""")
CorrectUsername = "PSYCHO"
CorrectPassword = "SOLDIER"
